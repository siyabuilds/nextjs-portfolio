    ...
    >
      ...
      <div className="bg-black/50 backdrop-blur-sm flex items-center justify-between h-10 px-4 select-none border-b border-zinc-800">
        <div className="flex items-center space-x-2">
          <div className="w-3 h-3 bg-emerald-500 rounded-full ring-1 ring-emerald-900 ring-inset"></div>
        ...
        <div className="flex-shrink-0">
          <button
            ...
            className={`
              ...
              transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-emerald-500
              ${
                buttonText === "Copied!"

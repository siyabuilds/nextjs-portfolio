...
const aboutSamson = {
  ...
  useEffect(() => {
    const typed = new Typed(typedRef.current, {
      strings: [
        "Crafting digital experiences with <span class='text-rose-400'>passion</span> and <span class='text-rose-400'>precision</span><span class='text-white'>.</span>",
      ],
      typeSpeed: 50,
      startDelay: 500,
      showCursor: true,
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {skills.map((skillGroup, index) => (
              ...
              >
                <h3 className="text-rose-400 font-mono text-sm font-semibold mb-4">
                  {skillGroup.category}
                </h3>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-l-2 border-rose-400 pl-6 space-y-4">
                <div>
                  <h3 className="font-mono text-rose-400 text-sm">2021</h3>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold">
              My <span className="text-rose-400">Approach</span>
            </h2>
            <div className="space-y-4">
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                <h3 className="font-mono text-rose-400 text-sm mb-2">
                  Learning Mindset
                </h3>
